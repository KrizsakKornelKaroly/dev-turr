          ...
          return (
            <div key={image.caption} className="p-2">
              <div className="border-2 border-gray">
                <div className=" flex justify-center self-center items-center mx-auto  rounded-sm bg-white max-h-fit min-h-full">
                  <div className="mx-auto items-center self-center text-center">
                    <div className="max-w-52 min-w-52 max-h-52 min-h-52 ">
                      <div className="flex">
